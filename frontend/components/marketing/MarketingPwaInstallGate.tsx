    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      ...
      >
        <button
          ...
          aria-label="Close"
          onClick={dismiss}
          className="absolute right-4 top-4 rounded-full p-1 text-zinc-400 hover:text-white"
        >
          <X className="h-5 w-5" />
        </button>
        <div className={cn("mb-4 flex h-12 w-12 items-center justify-center rounded-2xl", marketingTheme.iconBox)}>
          <Download className="h-6 w-6" />
        </div>
        <h2 className="text-xl font-semibold text-white">Install KhayaOS</h2>
