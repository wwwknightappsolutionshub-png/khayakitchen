...
export const platformThemes: Record<PlatformThemeMode, PlatformThemeChrome> = {
  ...
  light: {
    ...
    mobileSubtitle: "text-slate-500",
    sidebar: "border-slate-200 bg-white",
    sidebarBorder: "border-slate-200",
    brandTitle: "text-slate-900",
    brandMeta: "text-slate-500",
    closeButton: "text-slate-500 hover:bg-slate-100 hover:text-slate-900",
    navActive: "bg-violet-100 text-violet-900",
    navIdle: "text-slate-600 hover:bg-violet-50 hover:text-violet-900",
    footerBorder: "border-slate-200",
    userName: "text-slate-900",
    userMeta: "text-slate-500",
    signOut: "text-slate-600 hover:bg-slate-100 hover:text-slate-900",
    pwaInstall: "text-slate-600 hover:bg-violet-50 hover:text-violet-900",
