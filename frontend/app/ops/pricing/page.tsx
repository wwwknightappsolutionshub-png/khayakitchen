      ...
      <header className="border-b border-white/10 px-6 py-4">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <Link href="/ops/pricing" className="text-zinc-400 hover:text-white">
              Pricing
            </Link>
            <Link href="/ops/login" className="text-amber-400 hover:text-amber-300">
              Sign in
            </Link>
            {isSuperAdmin && (
              <Link href="/ops/platform/pricing" className="text-amber-400 hover:text-amber-300">
                Manage Plans
              </Link>
            )}
            <Link
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    window.location.href = `/ops/get-started?plan=${encodeURIComponent(plan.slug)}`;
                  }}
                >
